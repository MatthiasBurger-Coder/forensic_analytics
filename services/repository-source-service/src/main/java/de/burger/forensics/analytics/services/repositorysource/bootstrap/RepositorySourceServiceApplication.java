...
public class RepositorySourceServiceApplication {
    public static void main(String[] args) {
        run(args, applicationArgs -> SpringApplication.run(RepositorySourceServiceApplication.class, applicationArgs), System::exit);
    }
