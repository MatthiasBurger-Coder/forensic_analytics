...
public final class HealthProbe {
    ...
    public static int run(String[] args) {
        var host = option(args, "--forensics.analysis-store.service.health.host=", "127.0.0.1");
        var port = Integer.parseInt(option(args, "--forensics.analysis-store.service.health.port=", "8082"));
        try {
