...
public class QueryReportApiServiceApplication {
    public static void main(String[] args) {
        run(args, applicationArgs -> SpringApplication.run(QueryReportApiServiceApplication.class, applicationArgs), System::exit);
    }
