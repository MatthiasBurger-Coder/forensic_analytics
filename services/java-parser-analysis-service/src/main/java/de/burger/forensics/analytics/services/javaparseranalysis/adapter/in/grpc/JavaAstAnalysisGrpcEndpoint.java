...
import de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalyzeSourceSnapshotResult;
...
import static de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.requireText;
...
public final class JavaAstAnalysisGrpcEndpoint extends JavaAstAnalysisServiceGrpc.JavaAstAnalysisServiceImplBase {
    ...
    private static AnalyzeSourceSnapshotCommand command(AnalyzeSourceSnapshotRequest request) {
        return new AnalyzeSourceSnapshotCommand(
            new RequestMetadata(
                ...
                new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisRunId(
                    request.getAnalysisRunId().getValue()
                ),
                new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisJobId(
                    request.getAnalysisJobId().getValue()
                ),
                new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.SourceSnapshotId(
    ...
    private static de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ScanPolicy scanPolicy(
        ScanPolicy policy
    ) {
        return new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ScanPolicy(
            policy.getMaxFiles(),
    ...
    private static de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.SourceRoot sourceRoot(
        SourceRoot sourceRoot
    ) {
        return new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.SourceRoot(
            sourceRoot.getRelativePath(),
            sourceRoot.getLanguage()
        );
    }

    private static de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.JavaSourceFile sourceFile(
        JavaSourceFile sourceFile
    ) {
        return new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.JavaSourceFile(
    ...
    private static AnalysisArtifactReference artifact(
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisArtifactReference artifact
    ) {
    ...
    private static ArtifactByteAccess byteAccess(
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ArtifactByteAccess byteAccess
    ) {
    ...
    private static ScanSummary summary(
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ScanSummary summary
    ) {
    ...
    private static JavaAstDiagnostic diagnostic(
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.JavaAstDiagnostic diagnostic
    ) {
    ...
    private static DiagnosticSeverity severity(
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.DiagnosticSeverity severity
    ) {
