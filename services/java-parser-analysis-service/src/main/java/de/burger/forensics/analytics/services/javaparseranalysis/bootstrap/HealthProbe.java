...
final class HealthProbe {
    ...
    static int run(String[] args) {
        var host = value(args, "--forensics.java-parser-analysis.service.health.host=", "127.0.0.1");
        var port = value(args, "--forensics.java-parser-analysis.service.health.port=", "8085");
        try {
