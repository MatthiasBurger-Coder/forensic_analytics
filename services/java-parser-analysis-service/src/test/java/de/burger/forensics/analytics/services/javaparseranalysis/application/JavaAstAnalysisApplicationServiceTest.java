...
class JavaAstAnalysisApplicationServiceTest {
    ...
    void scansAndWritesArtifactResult() {
        ...
        assertEquals("java-parser-analysis/source-facts.json", result.sourceFactArtifact().artifact().path());
        assertEquals("java-parser-analysis-service", result.sourceFactArtifact().byteAccess().ownerService());
        assertEquals("analysis-job.v1.ArtifactBytes", result.sourceFactArtifact().byteAccess().retrievalContract());
        assertEquals("java-parser-analysis/source-facts.json", result.sourceFactArtifact().byteAccess().retrievalReference());
    ...
    private static final class FakeWriter implements AstResultArtifactWriterPort {
        ...
        public AnalysisArtifactReference write(
            ...
            return new AnalysisArtifactReference(
                new ArtifactReference("java-parser-analysis/source-facts.json", "application/json", "a".repeat(64), 10),
