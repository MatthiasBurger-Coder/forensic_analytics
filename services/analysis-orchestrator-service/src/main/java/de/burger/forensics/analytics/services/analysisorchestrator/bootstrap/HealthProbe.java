...
public final class HealthProbe {
    ...
    public static int run(String[] args) {
        var host = option(args, "--forensics.analysis-orchestrator.service.health.host=", "127.0.0.1");
        var port = Integer.parseInt(option(args, "--forensics.analysis-orchestrator.service.health.port=", "8089"));
        try {
