...
public class RepositoryAnalysisServiceApplication {
    public static void main(String[] args) {
        run(args, applicationArgs -> SpringApplication.run(RepositoryAnalysisServiceApplication.class, applicationArgs), System::exit);
    }
