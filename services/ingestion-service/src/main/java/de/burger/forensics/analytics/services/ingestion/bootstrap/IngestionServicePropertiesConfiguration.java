...
public class IngestionServicePropertiesConfiguration {
    @Bean
    public IngestionServiceProperties forensicIngestionServiceProperties(Environment environment) {
        return new IngestionServiceProperties(
            new IngestionServiceProperties.Grpc(
            ...
            new IngestionServiceProperties.Health(
