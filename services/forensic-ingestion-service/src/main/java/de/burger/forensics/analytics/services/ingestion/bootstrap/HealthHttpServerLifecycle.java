    ...
    public void start() {
        ...
        try {
            server = HttpServer.create(
                new InetSocketAddress(properties.health().host(), properties.health().port()),
                0
            );
            ...
            throw new IllegalStateException("Failed to start forensic ingestion health server", error);
        }
    }
