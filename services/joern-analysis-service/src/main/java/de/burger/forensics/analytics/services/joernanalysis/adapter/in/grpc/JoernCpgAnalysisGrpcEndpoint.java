...
public final class JoernCpgAnalysisGrpcEndpoint extends JoernCpgAnalysisServiceGrpc.JoernCpgAnalysisServiceImplBase {
    private static final Map<de.burger.forensics.analytics.analysisjob.v1.ArtifactByteCustody, de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteCustody> BYTE_CUSTODIES = Map.of(
        ...
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteCustody.SCOPED_OBJECT_ACCESS,
        de.burger.forensics.analytics.analysisjob.v1.ArtifactByteCustody.ARTIFACT_BYTE_CUSTODY_EXPLICIT_HANDOFF,
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteCustody.EXPLICIT_HANDOFF
    );
    private static final Map<de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteCustody, de.burger.forensics.analytics.analysisjob.v1.ArtifactByteCustody> BYTE_CUSTODY_PROTOS = Map.of(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteCustody.PRODUCER_RETAINED,
        de.burger.forensics.analytics.analysisjob.v1.ArtifactByteCustody.ARTIFACT_BYTE_CUSTODY_PRODUCER_RETAINED,
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteCustody.SCOPED_OBJECT_ACCESS,
        de.burger.forensics.analytics.analysisjob.v1.ArtifactByteCustody.ARTIFACT_BYTE_CUSTODY_SCOPED_OBJECT_ACCESS,
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.JoernMaterializationPolicy materializationPolicy(
        JoernMaterializationPolicy policy
    ) {
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.JoernMaterializationPolicy(
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.JoernCpgPolicy policy(
        JoernCpgPolicy policy
    ) {
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.JoernCpgPolicy(
            policy.getMaxSourceRoots(),
            policy.getMaxWorkspaceBytes(),
            policy.getMaxArtifactBytes(),
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactReference artifact(
        de.burger.forensics.analytics.repositoryanalysis.v1.ArtifactReference artifact
    ) {
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactReference(
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.SourceWorkspace workspace(
        SourceWorkspace workspace
    ) {
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.SourceWorkspace(
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.SourceRoot sourceRoot(
        SourceRoot sourceRoot
    ) {
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.SourceRoot(
    ...
    private static SourceRoot sourceRoot(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.SourceRoot sourceRoot
    ) {
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.AnalysisArtifactReference artifact(
        AnalysisArtifactReference reference
    ) {
        var artifact = reference.getArtifact();
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.AnalysisArtifactReference(
            new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactReference(
                artifact.getPath(),
                artifact.getType(),
                artifact.getSha256(),
                artifact.getSizeBytes()
    ...
    private static SourceWorkspace workspace(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.SourceWorkspace workspace
    ) {
    ...
    private static AnalysisArtifactReference artifact(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.AnalysisArtifactReference reference
    ) {
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.AnalysisArtifactCategory category(
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteAccess byteAccess(
        de.burger.forensics.analytics.analysisjob.v1.ArtifactByteAccess byteAccess
    ) {
        return new de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteAccess(
    ...
    private static de.burger.forensics.analytics.analysisjob.v1.ArtifactByteAccess byteAccess(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.ArtifactByteAccess byteAccess
    ) {
    ...
    private static JoernCpgSummary summary(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.JoernCpgSummary summary
    ) {
    ...
    private static JoernCpgDiagnostic diagnostic(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.JoernCpgDiagnostic diagnostic
    ) {
    ...
    private static DiagnosticSeverity severity(
        de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.DiagnosticSeverity severity
    ) {
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.AnalysisCompleteness completeness(
        ...
        return switch (completeness) {
            ...
            case ANALYSIS_COMPLETENESS_INCOMPLETE ->
                de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.AnalysisCompleteness.INCOMPLETE;
    ...
    private static de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.PackageAvailability availability(
        ...
        return switch (availability) {
            case PACKAGE_AVAILABILITY_AVAILABLE ->
                de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.PackageAvailability.AVAILABLE;
            case PACKAGE_AVAILABILITY_PENDING ->
                de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.PackageAvailability.PENDING;
            case PACKAGE_AVAILABILITY_UNAVAILABLE ->
                de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.PackageAvailability.UNAVAILABLE;
            case PACKAGE_AVAILABILITY_FAILED_INTEGRITY ->
                de.burger.forensics.analytics.services.joernanalysis.domain.JoernCpgAnalysisDomain.PackageAvailability.FAILED_INTEGRITY;
