...
public class ForensicGatewayServiceApplication {
    public static void main(String[] args) {
        run(args, applicationArgs -> SpringApplication.run(ForensicGatewayServiceApplication.class, applicationArgs), System::exit);
    }
