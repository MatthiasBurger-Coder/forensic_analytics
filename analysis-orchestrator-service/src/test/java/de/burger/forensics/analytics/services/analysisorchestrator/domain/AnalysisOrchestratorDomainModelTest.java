...
class AnalysisOrchestratorDomainModelTest {
    @Test
    void identifiersAndArtifactsValidateRequiredEvidenceMetadata() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new AnalysisArtifactReference(
    ...
    void jobTransitionsPreserveCompletenessAndRejectInvalidWorkers() {
        ...
        assertEquals(AnalysisJobState.DEAD_LETTERED, permanentFailure.state());
    }
