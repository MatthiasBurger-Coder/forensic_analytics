...
public final class GrpcServerLifecycle implements SmartLifecycle {
    private final AnalysisOrchestratorServiceProperties properties;
    private final AnalysisJobGrpcEndpoint endpoint;
    private Server server;
    private boolean running;

    public GrpcServerLifecycle(AnalysisOrchestratorServiceProperties properties, AnalysisJobGrpcEndpoint endpoint) {
    ...
    public void start() {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to start analysis orchestrator gRPC server", error);
        }
    }
