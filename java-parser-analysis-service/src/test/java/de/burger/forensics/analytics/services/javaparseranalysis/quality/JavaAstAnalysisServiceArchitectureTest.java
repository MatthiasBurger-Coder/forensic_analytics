package de.burger.forensics.analytics.services.javaparseranalysis.quality;
...
@AnalyzeClasses(
    packages = "de.burger.forensics.analytics.services.javaparseranalysis",
...
class JavaAstAnalysisServiceArchitectureTest {
    ...
    static final ArchRule domain_and_application_stay_free_of_framework_transport_and_parser_types =
        noClasses()
            .that()
            .resideInAnyPackage(
                "de.burger.forensics.analytics.services.javaparseranalysis.domain..",
                "de.burger.forensics.analytics.services.javaparseranalysis.application.."
            )
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(
    ...
    static final ArchRule service_does_not_depend_on_current_monolith_implementation_modules =
        noClasses()
            .that()
            .resideInAPackage("de.burger.forensics.analytics.services.javaparseranalysis..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(
    ...
    static final ArchRule domain_does_not_depend_on_application_adapters_or_bootstrap =
        noClasses()
            .that()
            .resideInAPackage("de.burger.forensics.analytics.services.javaparseranalysis.domain..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(
                "de.burger.forensics.analytics.services.javaparseranalysis.application..",
                "de.burger.forensics.analytics.services.javaparseranalysis.adapter..",
                "de.burger.forensics.analytics.services.javaparseranalysis.bootstrap.."
            );
    ...
    static final ArchRule application_does_not_depend_on_adapters_or_bootstrap =
        noClasses()
            .that()
            .resideInAPackage("de.burger.forensics.analytics.services.javaparseranalysis.application..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(
                "de.burger.forensics.analytics.services.javaparseranalysis.adapter..",
    ...
    static final ArchRule javaparser_api_stays_inside_outbound_adapter =
        noClasses()
            .that()
            .resideOutsideOfPackage("de.burger.forensics.analytics.services.javaparseranalysis.adapter.out.javaparser..")
            .should()
            .dependOnClassesThat()
