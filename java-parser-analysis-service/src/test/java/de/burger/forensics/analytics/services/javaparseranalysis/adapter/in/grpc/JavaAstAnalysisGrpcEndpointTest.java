...
import de.burger.forensics.analytics.services.javaparseranalysis.application.JavaAstAnalysisTimeoutException;
...
class JavaAstAnalysisGrpcEndpointTest {
    ...
    void analyzesSourceSnapshotThroughGrpcBoundary() throws Exception {
        ...
        assertEquals("ANALYZED_INCOMPLETE", complete.getStatus().getCode());
        assertEquals(AnalysisCompleteness.ANALYSIS_COMPLETENESS_INCOMPLETE, complete.getCompleteness());
        assertEquals(AnalysisCompleteness.ANALYSIS_COMPLETENESS_INCOMPLETE, parseError.getCompleteness());
        assertEquals(
            List.of("JAVA_PARSE_ERROR", "SYMBOL_RESOLUTION_NOT_CONFIGURED"),
            parseError.getDiagnosticsList().stream().map(diagnostic -> diagnostic.getCode()).sorted().toList()
        );
    }
    ...
    void mapsAllDomainEnumVariantsAtGrpcBoundary() throws Exception {
        startServerWithApplicationService(new JavaAstAnalysisApplicationService(
            command -> new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.JavaAstScanResult(
                List.of(new JavaSourceFact(
                    "fact-1",
                    "java-method",
                    "src/main/java",
                    new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.SourceLocation(
                    ...
                    "a.A#run()",
                    "AST method a.A#run()",
                    de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.EvidenceKind.STATIC_SOURCE_FACT
                )),
                List.of(
                    JavaAstDiagnostic.info(
                        new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.SourceSnapshotId("snapshot-1"),
                        "INFO",
                        "info"
                    ),
                    ...
                    new JavaAstDiagnostic(
                        "ERROR",
                        "error",
                        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.DiagnosticSeverity.ERROR,
                        new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.SourceSnapshotId("snapshot-1"),
                        "",
                        0,
                        0,
            ...
            (metadata, sourceFacts, diagnostics, summary) -> domainArtifact(
                de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ArtifactByteCustody.SCOPED_OBJECT_ACCESS,
                de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisCompleteness.UNKNOWN
            )
        ), request -> {
            throw new IllegalStateException("Source fact artifact is not available");
        });
        ...
        assertEquals(AnalysisCompleteness.ANALYSIS_COMPLETENESS_COMPLETE, scoped.getCompleteness());
        assertEquals(
        ...
        startServerWithApplicationService(new JavaAstAnalysisApplicationService(
            ...
            (metadata, sourceFacts, diagnostics, summary) -> domainArtifact(
                de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ArtifactByteCustody.EXPLICIT_HANDOFF,
        ...
        assertEquals(AnalysisCompleteness.ANALYSIS_COMPLETENESS_COMPLETE, handoff.getCompleteness());
        assertEquals(
    ...
    private static de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisArtifactReference domainArtifact(
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ArtifactByteCustody byteCustody,
        de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisCompleteness completeness
    ) {
        return new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisArtifactReference(
            new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ArtifactReference(
                "java-parser-analysis/source-facts.json",
                "application/json",
                "a".repeat(64),
                42
            ),
            de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.AnalysisArtifactCategory.STATIC,
            "java-parser-analysis-service",
            "schema-v1",
            completeness,
            new de.burger.forensics.analytics.services.javaparseranalysis.domain.JavaAstAnalysisDomain.ArtifactByteAccess(
                "java-parser-analysis-service",
                FileSystemAstResultArtifactWriter.BYTE_RETRIEVAL_CONTRACT,
                "java-parser-analysis/source-facts.json",
                byteCustody
