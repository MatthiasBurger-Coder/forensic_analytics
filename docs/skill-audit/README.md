...
The previous `docs/workplan/` content was removed and replaced with a workspace/gRPC workplan that explicitly keeps parser, Joern, BTM, replay, graph and UI work out of the current implementation phase.
