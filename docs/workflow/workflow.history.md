...
| Status | Workflow-create package committed; `workflow execute` active with Slice 00, Slice 01, Slice 02, Slice 03, Slice 04 and Slice 05 checkpoints pushed; Slice 06 post-fix quality gate passed and checkpoint is pending. |
...
01, 02, 03, 04, 05 and active Slice 06 have run for this workflow version and
are recorded there.
