...
| Status | Workflow-create package committed; `workflow execute` active with Slice 00, Slice 01 and Slice 02 checkpoints pushed; Slice 03 is in progress. |
...
01, 02 and 03 have run for this workflow version and are recorded there.
