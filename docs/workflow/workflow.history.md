...
| Status | Workflow-create package committed; `workflow execute` active with Slice 00, Slice 01, Slice 02, Slice 03 and Slice 04 checkpoints pushed; Slice 05 verification passed and checkpoint is pending. |
...
01, 02, 03, 04 and 05 have run for this workflow version and are recorded
there.
