...
@ConfigurationProperties(prefix = "forensics.joern-analysis.service")
public record JoernCpgAnalysisServiceProperties(
    ...
    public JoernCpgAnalysisServiceProperties {
        grpc = grpc == null ? new Grpc(true, "0.0.0.0", 9096) : grpc;
        health = health == null ? new Health(true, "0.0.0.0", 8087) : health;
        workspace = workspace == null ? new Workspace(Path.of("build/joern-analysis-workspaces")) : workspace;
        artifacts = artifacts == null ? new Artifacts(Path.of("build/joern-analysis-artifacts")) : artifacts;
        joern = joern == null ? new Joern(
            "joern",
            "joern-parse",
            "8G",
            Path.of("/opt/forensic-analytics/joern-analysis/queries"),
