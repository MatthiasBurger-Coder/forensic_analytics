---
name: forensic-devops-kubernetes
description: Use for Kubernetes material only after verifying that Forensic Analytics contains Kubernetes manifests or deployment tooling.
---
