---
name: forensic-orchestration-swarm-coordination
description: Use when explicitly coordinating multiple Forensic Analytics subagents or roles for bounded, parallel work.
---
