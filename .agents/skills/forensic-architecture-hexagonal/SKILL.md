---
name: forensic-architecture-hexagonal
description: Use for Forensic Analytics architecture work that must preserve hexagonal boundaries, domain isolation, ports/adapters separation, and evidence semantics.
---
...
Protect the Forensic Analytics core from technical frameworks, storage clients, runtime infrastructure, UI decisions and provider-specific SDKs.
