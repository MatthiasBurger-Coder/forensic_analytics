...
description: Use when drafting, reviewing, or validating a Forensic Analytics Git commit message from actual git status, diffs, changed-file classification, task scope, verification evidence, AGENTS.md, QUALITY.md, and commit-preparation output. Stops when message content would require guessing.
---
...
This skill does not decide commit readiness by itself. Use it after, or together with, the commit-preparation workflow and commit reviewer output.

## Authority

This skill specializes the message-writing part of `.agents/skills/commit-preparation/SKILL.md`.
...
When the commit-preparation workflow is active, also read:
...
- reviewer findings from the commit-preparation output when available.
...
- `.agents/skills/commit-preparation/SKILL.md` cannot be read,
