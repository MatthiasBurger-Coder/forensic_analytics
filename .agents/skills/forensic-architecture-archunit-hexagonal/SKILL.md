---
name: forensic-architecture-archunit-hexagonal
description: Use when adding, reviewing, or fixing Forensic Analytics ArchUnit rules for hexagonal architecture and forbidden dependencies.
---
