---
name: forensic-backend-protobuf
description: Use for Forensic Analytics Protobuf contract changes, ingestion messages, compatibility review, and schema-verification work.
---
