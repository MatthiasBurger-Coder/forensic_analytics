---
name: forensic-backend-java-25
description: Use for Forensic Analytics Java backend implementation that must follow the configured Java 25 Gradle toolchain and repository style.
---
