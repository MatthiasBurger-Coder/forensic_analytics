---
name: forensic-frontend-hexagonal
description: Use for frontend boundary design that separates UI components, frontend state, API adapters, and forensic evidence models.
---
