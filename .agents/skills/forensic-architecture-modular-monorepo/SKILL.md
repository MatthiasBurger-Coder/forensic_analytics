---
name: forensic-architecture-modular-monorepo
description: Use for Forensic Analytics module-boundary, Gradle project dependency, and monorepo responsibility changes.
---
