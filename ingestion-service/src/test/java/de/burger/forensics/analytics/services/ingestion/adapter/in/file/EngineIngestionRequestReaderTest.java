...
class EngineIngestionRequestReaderTest {
    ...
    void rejectsInvalidRequestModels() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new EngineIngestionImportResult("session-1", de.burger.forensics.analytics.services.ingestion.domain.IngestionStatus.COMPLETED, -1));
